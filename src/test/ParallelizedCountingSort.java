...
import static test.ArrayOperations.isSorted;
import static test.ArrayOperations.randomizeArray;



public class ParallelizedCountingSort {
	
	//genero varios tamaños para el testeo
    ...
    public static void hideSort() {
        ...
        //cuanto tardo en realizar el ordenamiento
        System.out.println("ORDENAMIENTO CONCURRENTE TARDO: " + (t1 - t0) + " milisegundos");
        
        //llama al metodo isSorted para verificar si esta ordenado
